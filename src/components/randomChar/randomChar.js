            ...
            {content}  
                <div className="randomchar__static">
                    ...
                    <button className="button button__main">
                        <div className="inner" onClick={changheRandomChar}>try it</div>
                    </button>
...
const View = ({char}) =>{
    ...
    let randomImg = 'randomchar__img'
    if (char.thumbnail === 'http://i.annihil.us/u/prod/marvel/i/mg/b/40/image_not_available.jpg') {
        randomImg += ' NotFound'
    }
    return(
        <div className="randomchar__block">
            <img src={thumbnail} alt="Random character" className= {randomImg}/>
